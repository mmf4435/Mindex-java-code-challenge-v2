...
public class CompensationServiceImplTest {
    ...
    @Autowired
    private com.mindex.challenge.service.CompensationService CompensationService;
    ...
    public void testCreateRead(){
        ...
        Compensation comp = new Compensation(createdEmployee.getEmployeeId(), new BigDecimal("0.00"), new Date(1000, 1, 1));
